...
pub struct Properties {
    ...
    #[serde(
    default = "full_user_name_default",
    rename = "full_user_name"
    )]
    pub full_user_name: String,
    #[serde(
    default = "param_url_default",
    rename = "param_url"
    )]
    pub param_url: String,
    #[serde(
    default = "test_password_default",
    rename = "test_password"
    )]
    pub test_password: String,
    #[serde(
    default = "test_sys_user_name_default",
    rename = "test_sys_user_name"
    )]
    pub test_sys_user_name: String,
    #[serde(
    default = "test_sys_password_default",
    rename = "test_sys_password"
    )]
    ...
    #[serde(default = "rpc_connect_timeout_default", rename = "rpc_connect_timeout")]
    ...
    #[serde(default = "rpc_operation_timeout_default", rename = "rpc_operation_timeout")]
    ...
    #[serde(default = "refresh_workers_num_default", rename = "refresh_workers_num")]
    pub refresh_workers_num: usize,
    #[serde(default = "max_conns_per_server_default", rename = "max_conns_per_server")]
    pub max_conns_per_server: usize,
    #[serde(default = "min_idle_conns_per_server_default", rename = "min_idle_conns_per_server")]
    pub min_idle_conns_per_server: usize,
    #[serde(default = "conn_init_thread_num_default", rename = "conn_init_thread_num")]
